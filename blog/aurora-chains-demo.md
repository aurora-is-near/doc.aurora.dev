...
authors: [slava]
tags: [tutorials]
image: https://doc.aurora.dev/img/1701394098-ac2.png
---
...
![](https://doc.aurora.dev/img/1682424716-screenshot-2023-04-25-at-12-05-26.png)

In the case of the Innovation Chain, we just need to fill in a simple form and submit it for review to Aurora:

![](https://doc.aurora.dev/img/1682424978-screenshot-2023-04-25-at-12-07-41.png)

After submitting it, you will need to wait for some time until you will get your access approved:

![](https://doc.aurora.dev/img/1682425059-screenshot-2023-04-25-at-13-17-04.png)

After approval, you will see this confirmation message:

![](https://doc.aurora.dev/img/1682425145-screenshot-2023-04-25-at-13-18-35.png)

And receive your first free 500 INNO tokens to be used:

![](https://doc.aurora.dev/img/1682425188-screenshot-2023-04-25-at-12-19-41.png)
...
![](https://doc.aurora.dev/img/1682455553-screenshot-2023-04-25-at-21-42-50.png)
...
![](https://doc.aurora.dev/img/1682455898-screenshot-2023-04-25-at-21-51-26.png)

After clicking the Swap button we will see the following info about the transaction in MetaMask:\

![](https://doc.aurora.dev/img/1682456030-screenshot-2023-04-25-at-21-53-11.png)
...
![](https://doc.aurora.dev/img/1682456144-screenshot-2023-04-25-at-21-55-03.png)
...
![](https://doc.aurora.dev/img/1682516992-screenshot-2023-04-26-at-14-49-39.png)
...
![](https://doc.aurora.dev/img/1682517331-screenshot-2023-04-26-at-14-54-31.png)
...
![](https://doc.aurora.dev/img/1682517522-screenshot-2023-04-26-at-14-58-15.png)

After clicking the "Connect NEAR Wallet" button, you will need to choose your wallet:

![](https://doc.aurora.dev/img/1682518634-screenshot-2023-04-26-at-14-59-01.png)
...
![](https://doc.aurora.dev/img/1682518704-screenshot-2023-04-26-at-15-13-30.png)
...
![](https://doc.aurora.dev/img/1682519151-screenshot-2023-04-26-at-15-14-10.png)

And just in a second, it is done! You will see this confirmation message with the link to the NEAR Explorer transaction:

![](https://doc.aurora.dev/img/1682519295-screenshot-2023-04-26-at-15-15-15.png)
...
![](https://doc.aurora.dev/img/1682519404-screenshot-2023-04-26-at-15-28-37.png)
...
![](https://doc.aurora.dev/img/1682520005-screenshot-2023-04-26-at-15-34-16.png)
...
![](https://doc.aurora.dev/img/1682520201-screenshot-2023-04-26-at-15-34-33.png)

Let's confirm it, and then we'll get this message:

![](https://doc.aurora.dev/img/1682520228-screenshot-2023-04-26-at-15-35-16.png)

We can check the transaction history in MetaMask to see that it has failed:

![](https://doc.aurora.dev/img/1682520426-screenshot-2023-04-26-at-15-45-58.png)

### Conclusions

Now we're at the end of the demo:

![](https://doc.aurora.dev/img/1682520850-screenshot-2023-04-26-at-15-35-27.png)
