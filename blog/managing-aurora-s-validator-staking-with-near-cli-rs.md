...
authors: [slava]
tags: [tutorials]
image: https://doc.aurora.dev/img/1715336122-ncrs.png
---
...
![](https://doc.aurora.dev/img/1714679129-screenshot-2024-05-02-at-20-45-17.png)
...
![](https://doc.aurora.dev/img/1714679473-screenshot-2024-04-26-at-12-12-20.png)

You will see a screen with different import options:

![](https://doc.aurora.dev/img/1714679597-screenshot-2024-05-02-at-20-52-57.png)
...
![](https://doc.aurora.dev/img/1714679775-screenshot-2024-04-26-at-12-13-22.png)
...
![](https://doc.aurora.dev/img/1714680087-screenshot-2024-05-02-at-20-59-05.png)

Then, you will get the next alert about successful authorization:

![](https://doc.aurora.dev/img/1714680117-screenshot-2024-05-02-at-20-59-31.png)

Now, you can go back to your terminal window, and you will see a message asking you to enter your account name again:

![](https://doc.aurora.dev/img/1714680166-screenshot-2024-05-02-at-21-00-07.png)

Enter it there and press `Enter`. After that, choose a keychain to store your keys. I am choosing the first option there:

![](https://doc.aurora.dev/img/1714679837-screenshot-2024-04-26-at-12-14-36.png)
...
![](https://doc.aurora.dev/img/1714680238-screenshot-2024-05-02-at-21-00-41.png)
...
![](https://doc.aurora.dev/img/1714681089-screenshot-2024-05-02-at-21-14-10.png)

Now, choose `delegation`:

![](https://doc.aurora.dev/img/1714681106-screenshot-2024-05-02-at-21-14-23.png)
...
![](https://doc.aurora.dev/img/1714681129-screenshot-2024-05-02-at-21-14-38.png)
...
![](https://doc.aurora.dev/img/1715217828-screenshot-2024-05-09-at-02-19-05.png)

Then, enter the amount of NEAR tokens to be staked, I am entering 1NEAR for the purpose of this demo:

![](https://doc.aurora.dev/img/1715218002-screenshot-2024-05-09-at-02-15-57.png)

Now, type in your validator address or choose from the list (you can use the `tab` key to autocomplete):

![](https://doc.aurora.dev/img/1715218061-screenshot-2024-05-09-at-02-16-28.png)

Choose the network now, I will opt for the `mainnet`:

![](https://doc.aurora.dev/img/1715218288-screenshot-2024-05-09-at-02-16-56.png)

After this, you will see your transaction formed and ready to be signed. By default, I am signing it with my keychain:

![](https://doc.aurora.dev/img/1715218347-screenshot-2024-05-09-at-02-17-12.png)

Now, you can `send` the transaction and execute it:

![](https://doc.aurora.dev/img/1715218434-screenshot-2024-05-09-at-02-17-47.png)

You will see the transaction ID and a link to the Explorer after the successful execution:

![](https://doc.aurora.dev/img/1715218479-screenshot-2024-05-09-at-02-19-35.png)
...
![](https://doc.aurora.dev/img/1715219903-screenshot-2024-05-09-at-02-53-21.png)
...
![](https://doc.aurora.dev/img/1715219915-screenshot-2024-05-09-at-02-52-57.png)
...
![](https://doc.aurora.dev/img/1714681248-screenshot-2024-05-02-at-21-17-51.png)
...
![](https://doc.aurora.dev/img/1715334843-screenshot-2024-05-10-at-10-25-15.png)
...
![](https://doc.aurora.dev/img/1715335148-screenshot-2024-05-10-at-10-58-39.png)
