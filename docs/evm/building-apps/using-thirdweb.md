...
This document will show you how to interact with your contract deployed to Aurora using React
...
### Initialize SDK On Aurora

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Aurora
