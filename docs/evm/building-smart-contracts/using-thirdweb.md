...
5. After modifying your contract with your desired custom logic, you may deploy it to Aurora using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Aurora as the network
